...
Regardless, if even for experiemntal purposes, I still wanted to get antiX running on some hardware. This is the attitude I took to the MacBook5,1.
...
## Bonus Mac install: A 2012 MacBook Air
...
Given the 8 GB of RAM, and my good experience with MX Linux, I went with MX's "flagship" Xfce install. Installation went very smoothly -- don't think I even needed to edit the GRUB parameters.

...
* The iMac, an iMac5,1, can only be upgraded to 10.7.5 Lion ([source](https://discussions.apple.com/thread/6584536)), which stopped being supported by Apple years ago. It has 1 GB of RAM (I think [these are roughly the correct specs](https://igotoffer.com/apple/imac-core-2-duo-2-16-20-inch)).
* The MacBook is a MacBook5,1. The latest OS it can handle is [apparently OS X 10.11 El Capitan](https://igotoffer.com/apple/macbook-5#Specifications), which is also no longer supported. It has 2 GB of RAM. (Here are what I think are [some accurate specs](https://igotoffer.com/apple/macbook-5).)
...
Note: If you need to wipe a computer that has a solid-state drive, I'd point you to [this guide](https://www.nytimes.com/wirecutter/guides/how-to-securely-wipe-your-computer-devices/).

## A lightweight Linux distro? 

So, with no support from Apple for either of these computers, I looked to Linux. Given that the iMac has only 1 GB of RAM and the Macbook has 2 GB, I knew I needed a _lightweight_ Linux distribution (aka "distro").
...
Excited, I went to actually install antiX to this hard drive; but I quickly hit a new set of issues that I won't bother laying out here. 

### MX+Fluxbox to the rescue

Then I remembered something: In my search for a suitable distro, I tried [MX Linux](https://mxlinux.org/), "a cooperative venture between the antiX and MX Linux communities" with its default Xfce desktop. 
...
The [antiX forum](https://www.antixforum.com) has some posts about looks, including [how to model it after macOS](https://www.antixforum.com/forums/topic/how-to-make-antix-look-like-macos-with-jwm/). I generally liked how MX Linux looks out of the box, especially the flagship Xfce version, which I think uses a modified version of [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme), a theme I had used before.
...
For a dock for antiX, I might I've heard a lot about [Plank](https://github.com/ricotz/plank), but have also seen that it eats about 25 mb of RAM.

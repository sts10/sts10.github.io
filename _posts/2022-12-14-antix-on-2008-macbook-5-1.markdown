...
I was visiting family this past weekend and saw an iMac from 2007 and MacBook from 2008 destined for the trash. As the tech nerd of the family, I was asked if these machines were still useful at all.
...
I _think_, based on serial number, the MacBook is a MacBook5,1. The latest OS it can handle is [apparently OS X 10.11 El Capitan](https://igotoffer.com/apple/macbook-5#Specifications), which is also no longer supported.
...
So, with no support from Apple, I looked to Linux. Given that the iMac has only 1 GB of RAM and the Macbook has 2 GB, I knew I needed a lightweight Linux distribution (aka "distro").

In a past situations like this I have [used Lubuntu](https://sts10.github.io/2016/11/08/installing-ubuntu-on-my-old-macbook-pro.html) and [Puppy Linux](https://sts10.github.io/2022/08/23/reviving-a-thinkpad-x40.html), but figured I should look around for something new to me and maybe more challenging. (Besides, Lubuntu felt _a little_ too heavy for 1 GB of RAM, and I'm not sure if Puppy installs well with UEFI.)
...
I actually installed MX Linux with its Xfce desktop on a 2012 MacBook Air after all of this (it installed pretty easily), and in both the Xfce and Fluxbox desktops, I found the defaults to be sane. 
...
I had easier success with antiX and the MacBook 5,1. (Here are what I think are [some accurate specs](https://igotoffer.com/apple/macbook-5).)

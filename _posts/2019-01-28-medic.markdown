...
You might be asking: But you said this file had passwords in it. What's a SHA-1 hash? [Here's a good explainer video](https://www.youtube.com/watch?v=b4b8ktEV4Bg), [another video](https://www.youtube.com/watch?v=DMtFhACPnTY), and here's the [Wikipedia page](https://en.wikipedia.org/wiki/SHA-1). But basically a hash is way to represent a piece of data (in this case, a password) without actually revealing it. An example: The SHA-1 hash of "password" is `5BAA61E4C9B93F3F0682250B6CF8331B7EE68FD8`, which was the 4th most common password in the breach with a whopping 3,645,804 appearances.
